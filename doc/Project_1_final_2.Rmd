...
```{r}
# Male<-subset(masterchinese.pus,prime_OCCP_master_or_higher.chinese$SEX=="Male")
# Female<-subset(masterchinese.pus,prime_OCCP_master_or_higher.chinese$SEX=="Female")
...
## Well-educated Chinese Imigrants' gender distribution on different ages
...
#Gender distribution in each occupation 
